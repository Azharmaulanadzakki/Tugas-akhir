    ...
    <body class="bg-gray-100 antialiased">
        ...
        <section class="mx-20">
            ...
            <section class="mx-11 my-6">
                        ...
                        <div id="mapel-list-{{ $index }}" class="rounded-xl shadow-lg mapel-item"
                            ...
                            <div class="rounded-xl shadow-lg">
                                ...
                                <div class="p-4 flex flex-col">
                                    <h5 class="text-md md:text-lg font-medium mt-3"> {{ $mapel->judul }}</h5>
                                    <h7 class="text-sm md:text-md"> Rp. {{ $mapel->harga }}</h7>
                                    <p class="text-slate-400 text-md mt-3"> {{ $mapel->description }} </p>
                                </div>
                            </div>
                ...
                <button id="showMoreBtn" class="my-3 rounded-md px-9 py-2 bg-black text-white font-semibold hover:bg-gray-900 duration-300">Show More</button>
                <button id="lessMoreBtn" style="display: none; " class="my-3 rounded-md px-9 py-2 bg-black text-white font-semibold hover:bg-gray-900 duration-300">Less More</button>
            </section>
            {{-- end card --}}
